...
public class ManagerPluginNewWizard extends Wizard implements INewWizard {
	private ManagerPluginNewWizardPage page;
	private ISelection selection;

	/**
	 * Constructor for ManagerPluginNewWizard.
	 */
	...
	public void addPages() {
		page = new ManagerPluginNewWizardPage(selection);
		addPage(page);
	}
	...
	private void throwCoreException(String message) throws CoreException {
		IStatus status =
			new Status(IStatus.ERROR, "net.bioclipse.sdk", IStatus.OK, message, null);
